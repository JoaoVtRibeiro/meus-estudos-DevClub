/* 
    ...
    2. [x] Escreva um programa onde, você chame uma função enviando um número 
    ...
    6. [x] A prefeitura de uma cidade fez uma pesquisa entre seus habitantes, coletando dados sobre o salário e número de filhos. 
