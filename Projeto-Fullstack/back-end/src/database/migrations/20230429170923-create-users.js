...
module.exports = {
  async up (queryInterface, Sequelize) { // Método que é executado no banco de dados quando a migration é aplicada 
  ...
  async down (queryInterface) { // Método que pode reverter alterações caso necessário, executado quando a migration é revertida
