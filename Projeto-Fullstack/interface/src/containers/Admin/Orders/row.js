...
// Formatação de cada pedido/item da array (array 'rows' em orders/index.js)
            ...
            <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
                ...
                <TableCell>
                    <ReactSelectStyle
                        ...
                        placeholder="Status"
                        // Definindo o valor inicial a partir do status de cada row(pedido/item), null para caso ele não carregue ao tempo da pagina ou nao encontre
                        defaultValue={
                            status.find(
