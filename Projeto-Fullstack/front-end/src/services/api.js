...
apiCodeBurger.interceptors.request.use(async config => {
    ...
    // Passando os dados de string para objeto e pegando o token ("userData &&"" = só vai executar essa ação SE o userData existir, para não quebrar a aplicação em páginas que não precisam do token)
